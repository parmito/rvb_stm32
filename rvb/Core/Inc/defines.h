...
#define EVENT_IO_PS 				(unsigned char)4
#define EVENT_IO_WAKEUP				(unsigned char)5
#define	EVENT_IO_LED_NULL			(unsigned char)6

#define EVENT_APPCAN_INIT 	        (unsigned char)0
#define EVENT_APPCAN_RX				(unsigned char)1
#define EVENT_APPCAN_TX 			(unsigned char)2
#define EVENT_APPCAN_PS 			(unsigned char)3
#define EVENT_APPCAN_SLEEP 			(unsigned char)4
#define	EVENT_APPCAN_NULL			(unsigned char)5
...
#define EVENT_APPSERIAL_PS 			(unsigned char)3
#define	EVENT_APPSERIAL_NULL		(unsigned char)4
...
#define TASK_APPCAN_RS    			(unsigned char)3
#define TASK_APPCAN_SLEEPING    	(unsigned char)4
